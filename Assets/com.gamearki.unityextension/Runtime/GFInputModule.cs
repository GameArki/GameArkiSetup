...
namespace UnityEngine.EventSystems
{
    ...
    /// </remarks>
    public class GFInputModule : PointerInputModule
    {
        ...
        public Func<float> GetHorizontalHandle;
        public Func<float> GetHorizontalButtonHandle;
        public Func<float> GetVerticalHandle;
        public Func<float> GetVerticalButtonHandle;
        public Func<bool> GetSubmitHandle;
        public Func<bool> GetCancelHandle;

        protected GFInputModule()
        {
        }
        ...
        public override bool ShouldActivateModule()
        {
            ...
            shouldActivate |= GetSubmitHandle.Invoke();
            shouldActivate |= GetCancelHandle.Invoke();
            shouldActivate |= !Mathf.Approximately(GetHorizontalHandle.Invoke(), 0.0f);
            shouldActivate |= !Mathf.Approximately(GetVerticalHandle.Invoke(), 0.0f);
        ...
        protected bool SendSubmitEventToSelectedObject()
        {
            ...
            if (GetSubmitHandle.Invoke())
                ExecuteEvents.Execute(eventSystem.currentSelectedGameObject, data, ExecuteEvents.submitHandler);

            if (GetCancelHandle.Invoke())
        ...
        private Vector2 GetRawMoveVector()
        {
            ...
            move.x = GetHorizontalHandle.Invoke();
            move.y = GetVerticalHandle.Invoke();

            if (GetHorizontalButtonHandle.Invoke() != 0)
            {
                if (move.x < 0)
                    move.x = -1f;
                if (move.x > 0)
            ...
            if (GetVerticalButtonHandle.Invoke() != 0)
            {
                if (move.y < 0)
                    move.y = -1f;
                if (move.y > 0)
