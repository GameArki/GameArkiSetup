...
namespace GameArki.TripodCamera {
    ...
    public static class TCDollyTrackRuntimeUtil {

        public static TCWayPoint GetBezierWayPointLv3(in TCBezierSplineModel line, float ratioT) {
        ...
        public static TCWayPoint GetBezierWayPointLv3(TCBezierSplineModel[] lineArray, float t, out int elementIndex, out float ratioT) {
            elementIndex = 0;
            ratioT = 0;
    ...
    public static class SplineExtension {
        ...
        public static Vector3 GetTangentDir(this TCBezierSplineModel bezier3D3Line, float ratioT) {
